 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://webservice.haegar.de/", wsdlLocation = "http://haegar.fh-swf.de:8081/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://webservice.haegar.de/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://haegar.fh-swf.de:8081/calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://webservice.haegar.de/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.haegar.de/", "CalculatorPort"), Calculator.class, features);
    }
