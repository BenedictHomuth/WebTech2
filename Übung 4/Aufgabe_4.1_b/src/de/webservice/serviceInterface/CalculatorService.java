 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://service.webservice.de/", wsdlLocation = "http://localhost:8080/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://service.webservice.de/", "CalculatorService");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://service.webservice.de/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.webservice.de/", "CalculatorPort"), Calculator.class, features);
    }
